...
/** Load once from /public/occupations.csv and cache */
export async function loadOccupations() {
  if (_cache) return _cache;
  try {
    const url = "/occupations.csv"; // must live in <project>/public/occupations.csv
    ...
    console.error("[occupations] Failed to load occupations.csv:", e);
    _cache = [];
    return _cache;
  }
}
